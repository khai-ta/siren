...
def run_investigation(metrics_csv: str | Path, top_k: int = 12, reindex: bool = True) -> dict[str, Any]:
...
def main() -> None:
    args = parse_args()
    result = run_investigation(args.metrics_csv, top_k=args.top_k, reindex=args.reindex)
